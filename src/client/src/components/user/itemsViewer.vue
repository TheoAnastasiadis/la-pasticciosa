<template>
  ...
  <p>
    ...
    <strong>από τον διαχειριστή</strong>. Τα προϊόντα αυτά είναι είναι διαθέσιμα
    για παραγγελία. Αν επιθυμείτε να προστεθεί στον κατάλογό σας κάποιο νέο
    προϊόν παρακαλώ μην διστάσετε να επικοινωνήσετε με εμάς και θα χαρούμε να
    δουλέψουμε μαζί για να την δημιουργία του προϊόντος που θα καλήψει τις
    ανάγκες σας!
  </p>
  <div class="listing">
...
export default {
  ...
  async mounted() {
    ...
    this.loading = true;
    this.items = await backend.viewAssignedItems.query().catch(() => {
      toast(
