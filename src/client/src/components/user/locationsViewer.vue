<template>
  <p>
    ...
    αποδεκτές από τον διαχειριστή και μπορείτε να της επιλέξετε στην δημιουργία
    παραγγελιών. Για να αιτηθείτε μια νέα τοποθεσία χρησιμοποιήστε τον σύνδεσμο
    <strong>ΝΕΑ ΑΙΤΗΣΗ</strong>.
  </p>
  <div class="xt-row xt-row-2">
      ...
      <div class="card rounded-md p-3 bg-white shadow-md border">
        ...
        >
          <a
            ...
            >{{ location.state === "requested" ? "Σε Αναμονή" : "Ενεργό" }}
            <i
              class="text-sm h"
              :class="{
          ...
          <div class="xt-tooltip p-3" data-xt-tooltip-target>
            <div
              class="xt-card rounded-md shadow-md text-white xt-links-inverse font-medium bg-black"
            >
              <div class="py-2 px-2.5 text-xs">
                {{
                  location.state === "requested"
                    ? "Οι τοποθεσίες παράδοσης που είναι σε αναμονή δεν μπορούν να χρησιμοποιηθούν σε παραγγελίες."
                    : "Οι ενεργές τοποθεσίες παράδοσης μπορούν να χρησιμοποιηθούν σε παραγγελίες."
                }}
              </div>
            </div>
          </div>
    ...
    <div class="w-full md:w-4/12">
      <div class="card rounded-md border border-dashed border-gray-400 p-2">
        ...
        <deliveryCreator @delivery-requested="(l) => this.locations.push(l)" />
      </div>
    </div>
  </div>
</template>
