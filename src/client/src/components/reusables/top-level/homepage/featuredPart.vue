<template>
  <div class="container py-14">
    ...
    >
      ...
      <img
        src="/whole.jpg"
        class="w-full md:w-5/12 object-cover absolute top-0 saturate-50 z-[9] rounded-xl pointer-events-none"
          ...
          <div class="leading-relaxed p-8">
            ...
            <div class="flex flex-col md:flex-row mb-2">
              <div
                ...
                class="text-black bg-white rounded-sm px-2.5 py-0.5 font-semibold mr-3 mb-2 overflow-hidden"
              >
...
const { title, content, keywords, invertOrder, scrollContainer } = defineProps<{
  title: string;
  content: string;
  keywords: string[];
  invertOrder?: boolean;
