      ...
      >
        <div class="text-center mt-1.5">
          <i
            class="h text-3xl"
            :class="{
              'h-circle opacity-100': !active,
              'h-check-circle-1 opacity-100': active,
            }"
          ></i>
        </div>
      </a>
